    ...
    <div class="page-header d-print-none">
      <div class="container-xl">
        <div class="title-wrapper">
          <div>
            <a href="{{ url()->previous() == route('surat.indexHistory') ? route('surat.indexHistory') : route('surat.index') }}" class="btn btn-link px-0 py-1 mb-1">
                      ...
                      <div class="mb-4" x-data="fileUpload">
                        ...
                        <div class="row g-2">
                          <div class="col">
                            ...
                            <span class="d-block text-secondary mt-1">pdf, docx (Max: 2 MB)</span>
                          </div>
