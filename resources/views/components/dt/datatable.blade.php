        ...
        <div class="row g-2">
          <div class="col">
            <div class="input-group">
              <input type="text" id="search" name="{{ $search }}" class="form-control" placeholder="Pencarian" value="{{ request()->filter[$search] ?? '' }}"
                autocomplete="off">
              @if (isset(request()->filter[$search]))
                <button type="button" id="dt-btn-clear" class="btn btn-icon">
                  <svg class="icon text-red" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor"
        ...
        <div class="card-footer bg-white">
          ...
          @if ($totalFilter)
            <button type="button" id="dt-form-clear" class="btn btn-icon">
              <svg class="icon text-red" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                stroke-linecap="round" stroke-linejoin="round">
                <path d="M18 6 6 18" />
                <path d="m6 6 12 12" />
              </svg>
