  ...
  <div class="d-flex flex-column flex-md-row justify-content-between">
    @if ($searchField)
      <form id="dtb-search" class="col-12 col-md-6 col-lg-4">
        ...
        <div class="input-group">
          <input type="text" id="search" name="{{ $searchField }}" class="form-control" placeholder="Pencarian" value="{{ request()->filter[$searchField] ?? '' }}">
          @if (isset(request()->filter[$searchField]))
          <button id="dtb-form-clear" class="btn btn-icon">
    ...
    @isset($filter)
      <div class="col-12 col-md-auto mt-3 mt-md-0">
        <button class="btn btn-filter" data-bs-toggle="collapse" data-bs-target="#{{ $collapseFilterId = uniqid() }}" aria-expanded="false" aria-controls="false">
