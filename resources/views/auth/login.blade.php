  ...
  <div class="container container-tight py-4">
    ...
    <div class="card">
      <div class="card-header">
        <h2 class="h2 text-center mb-0">Masuk ke Akun Anda</h2>
      </div>
      <div class="card-body">
        <form action="./" method="get" autocomplete="off" novalidate>
          ...
          <div class="mb-2">
            <label class="form-check">
              ...
              <span class="form-check-label">Ingat sesi di perangkat ini</span>
            </label>
          </div>
          <div class="form-footer">
            <button type="submit" class="btn btn-main w-100">Masuk</button>
            <a class="btn btn-outline-secondary w-100 mt-2">Belum punya akun? Daftar sekarang</a>
          </div>
        </form>
      </div>
    </div>
