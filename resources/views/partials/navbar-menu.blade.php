    ...
    <div class="navbar">
      <div class="container-xl">
        <ul class="navbar-nav">
          ...
          @role('admin')
          <li @class([ 'nav-item dropdown' , 'active'=> request()->is('registrasi/*'),
            ])>
            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                <div class="dropdown-menu-column">
                  <a href="{{ route('registrasi.index') }}" @class([ 'dropdown-item' , 'active'=>
                    request()->routeIs('registrasi.index') ||
                    request()->routeIs('registrasi.show'),
                    ])>Proses Registrasi</a>
                  <a href="{{ route('registrasi.indexLog') }}" @class([ 'dropdown-item' , 'active'=>
                    request()->routeIs('registrasi.indexLog'),
                    ])>Log Permohonan</a>
                  <a href="{{ route('migrasi.index') }}" @class([ 'dropdown-item' , 'active'=>
          ...
          <li @class(['nav-item dropdown', 'active'=> request()->is('surat/*')])>
            ...
            <div class="dropdown-menu">
              <div class="dropdown-menu-columns">
                ...
                <div class="dropdown-menu-column">
                  <a href="{{ route('surat.letterbox') }}" @class([ 'dropdown-item' , 'active'=>
                    request()->routeIs('surat.letterbox'),
                    ])>Kotak Surat</a>
                  <a href="{{ route('surat.indexWilayah') }}" @class([ 'dropdown-item' , 'active'=>
                    request()->routeIs('surat.indexWilayah'),
                    ])>Permohonan Wilayah</a>
                </div>
                @else
                <div class="dropdown-menu-column">
                  <a href="{{ route('surat.index') }}" @class([ 'dropdown-item' , 'active'=>
                    request()->routeIs('surat.index'),
                    ])>Proses Permohonan</a>
                  <a href="{{ route('surat.indexHistory') }}" @class([ 'dropdown-item' , 'active'=>
                    request()->routeIs('surat.indexHistory'),
          ...
          <li @class([ 'nav-item' , 'active'=>
            ...
            <a class="nav-link"
              href="{{ Auth::user()->hasPermissionTo('join-event') ? route('kegiatan.indexJoined') : route('kegiatan.index') }}">
              <span class="nav-link-icon d-md-none d-lg-inline-block">
